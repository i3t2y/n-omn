...
> 基础镜像: diegosouzapw/omniroute:3.8.43@sha256:517c160643c56ad72e3e305458d961c9a4c87f711393c13020450f9f088d1570
> gate.js: express 框架 (依赖 package.json) · entrypoint.sh: 完整 trap/restore/purge 时序 · init-nim-keys.sh: v4.3.0

## 文件清单

`Dockerfile` · `entrypoint.sh` · `gate.js` · `init-nim-keys.sh` · `litestream.yml` · `package.json` · `README.md`
...
# ─────────────────────────────────────────────────────────────
# NIM OmniRoute initializer  v4.3.0（基于 v4.2.3）
# 相对 v4.2.2 的变更：
...
hf_snapshot() {
  ...
  # ── 【v4.3.0·⑨ 】DEBUG log 上传到 Dataset（debug_<时间戳>.log）──
