---
name: handoff
description: omn 会话收尾时生成交接块 + 提议 ops/STATUS.md 与 ops/DECISIONS.md 更新 diff。固化 CLAUDE.md §0 生命周期(结束输出交接块供 Zen 归档), 避免交接块格式每轮漂移。triggers: "会话结束" "交接" "收尾" "归档摘要" "STATUS 更新" "DECISIONS 追加" "下一步" "未决问题"
---
